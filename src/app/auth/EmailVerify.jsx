...
const EmailVerify = () => {
  ...
  return (
     <View >
      ...
      >
        <View
          style={tw`p-[4%] h-full  dark:bg-black flex-col items-center justify-center `}
        >
          {/*  */}

          <AuthHeading Heading={'Forgot password'} SubHeading={' Enter your email address to reset your password'} />
