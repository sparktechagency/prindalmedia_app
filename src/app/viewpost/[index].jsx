    ...
    <View style={tw`p-[4%]`} >
      ...
      <View style={tw`flex-row items-center mb-3`}>
        ...
        <View>
          ...
          <Text style={tw`text-gray-500 text-sm`}>🍴 45 Portland, Oregon</Text>
        </View>
      </View>

      {/* Image */}
      <Image
        source={{ uri: 'https://images.unsplash.com/photo-1600891964599-f61ba0e24092?auto=format&fit=crop&w=800&q=80' }}
      ...
      <Text style={tw`text-sm text-gray-700`}>
        Indulge in a creamy fettuccine Alfredo, tossed with tender chicken and fresh parsley.
      </Text>
    </View>
    </View>
  )
